...
/**
 * Created by paulomimahidharia on 7/4/17.
 */
public class ExtractWT2G {

    public static ReturnData getData() throws FileNotFoundException, UnsupportedEncodingException {

        PrintWriter writer = new PrintWriter("OutCntWT2G.txt", "UTF-8");
        ...
        //	 File f1 = new File("/Users/paulomimahidharia/Desktop/IR/PageRank/MergedGraph/temp.txt");
        	 File f1 = new File("/Users/paulomimahidharia/Desktop/IR/PageRank/MergedGraph/wt2g_inlinks.txt");
        ...
        S.addAll(P);
        for (Map.Entry<String, Double> m : LQ.entrySet()) {
